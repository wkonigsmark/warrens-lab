...
import { TOPICS, getTopic } from '../../lib/fractionWorksheet'
import Worksheet from './Worksheet'

// Topic picker → mode picker (practice / helper) → printable worksheet.
    ...
    return (
      <div className="max-w-xl mx-auto">
        <motion.div className="bg-white rounded-2xl shadow-lg p-10 text-center" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}>
          <h1 className="text-2xl font-bold text-gray-800 mb-1">Choose a style</h1>
