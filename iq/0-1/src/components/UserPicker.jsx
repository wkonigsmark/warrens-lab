...
// "Who's playing?" — roster gate before the app. Live roster from Supabase;
// Guest is always available and PIN-free.
export default function UserPicker({ onSelect }) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 to-indigo-100 flex flex-col items-center justify-center gap-8 px-6">
      <img
        src="/banner-0-1.png"
        alt="0 → 1"
        className="h-40 w-auto object-contain rounded-2xl shadow-lg"
      />
