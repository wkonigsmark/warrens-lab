...
// (Copied from the ants-fractions reference wiring.)
export default function PinGate({ user, onCancel, children }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 to-indigo-100 flex items-center justify-center px-6">
      <form onSubmit={submit} className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-xs text-center">
        ...
        <input
          ...
          className={`w-full text-center text-2xl tracking-widest border-2 rounded-xl py-3 mb-3 outline-none ${
            error ? 'border-red-400' : 'border-gray-200 focus:border-cyan-400'
          }`}
        />
        ...
        <button
          ...
          className="w-full bg-cyan-600 text-white font-bold py-3 rounded-xl disabled:opacity-50"
        >
