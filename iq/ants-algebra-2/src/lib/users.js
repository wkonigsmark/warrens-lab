...
// existing consumer (UserPicker, PinGate, Banner, AlgebraQuizMode,
// AlgebraAdminView) keeps reading these exactly as before. Live ES module
// bindings mean reassigning them here updates every importer.
export let USERS = []
...
const USER_KEY = 'ants-algebra-user'
