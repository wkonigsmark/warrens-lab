...
// "Who's playing?" — roster gate. Live roster from Supabase; Guest is PIN-free.
export default function UserPicker({ onSelect }) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-violet-100 flex flex-col items-center justify-center gap-8 px-6">
      <img
