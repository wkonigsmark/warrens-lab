...
// Live roster, mirrors the other /iq tools. Populated by loadRoster() before the
// app renders (main.jsx); live ES-module bindings mean reassigning here updates
// every importer (UserPicker, PinGate, Banner).
export let USERS = []
...
const USER_KEY = 'ants-exponents-user'
