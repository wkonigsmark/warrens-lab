...
// not just on next launch. (Copied from the ants-angles reference wiring.)
export default function PinGate({ user, onCancel, children }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-cyan-100 flex items-center justify-center px-6">
